package com.lyg.tools.blog.lookblog;
...
public class LookBlogActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_look_blog);
        webView = findViewById(R.id.lookBlogWeb);
        initWebView();
    }
